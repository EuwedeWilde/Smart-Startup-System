void setupMqtt() {
  ...
  while (!mqttClient.connect(_cfg.mqttServer, _cfg.mqttPort)) {
    dbf("Attempting to connect to MQTT broker...\n");
    delay(1000);
  }
